...
function createCountryCard(c) {
    ...
    <div onclick="handleCountryClick('${c.cca3}')"
         class="grid grid-cols-12 items-center bg-white p-10 rounded-xl shadow-sm border border-gray-100 hover:shadow-md transition cursor-pointer">
        ...
        <div class="col-span-3">
            ...
            <p class="text-xs font-semibold text-gray-900">${capital}</p>
        </div>
        ...
        <div class="col-span-3 pr-8">
            <div class="flex justify-between text-xs font-bold mb-1">
                <span class="text-black">POPULATION</span>
        ...
        <div class="col-span-4">
            <div class="flex justify-between text-xs font-bold mb-1">
                <span class="text-black">AREA</span>
